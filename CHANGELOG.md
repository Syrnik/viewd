...
- Extended `exclude.php` file list to exclude additional development artifacts from release bundle
...
[2.0.2]: https://github.com/Syrnik/viewd/compare/v2.0.1...v2.0.2
